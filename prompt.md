...
- design.md文件为设计文档, 用于指导Code Agent开发, 禁止AI修改design.md文件
...
- **创建或更新项目规划**：根据prompt.md文件中的要求, 按照design.md文件中的设计, 在plan.md文件中创建或者更新项目短期、中期、长期功能规划, 确保可以长期迭代演进。
...
- **禁止额外作者**：使用git默认用户为作者, 绝对禁止添加"claude"、"qwen"为额外作者。
